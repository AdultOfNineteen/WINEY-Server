...
import com.example.wineycommon.exception.OtherServerException;
import feign.FeignException;
import feign.Response;
import feign.codec.ErrorDecoder;

import static com.example.wineycommon.exception.errorcode.OtherServerErrorCode.*;
import static com.example.wineycommon.exception.errorcode.OtherServerErrorCode.OTHER_SERVER_BAD_REQUEST;

public class GoogleOauth2ErrorDecoder implements ErrorDecoder {
